...
void intro()
 {
   printf("\n\t             Near BSF Chowk, G.T. Road, udaipur City,\n\t\t\t\t udaipur 313001, INDIA");
   printf("\n\n                              Ph. No.:82900885144");
   printf("\n\n\n                             WELCOMES YOU..............");
   printf("\n\n\n\tHotel Gagan Inn is one of the newest Hotel in udaipur. The Hotel is \t\tequipped with with all the general amenities and facilities that go \t\talong with memorable stay. Set amidst beautifully landscaped gardens, \t\tit proves to be a ideal dream destination for perceptive traveller.");
